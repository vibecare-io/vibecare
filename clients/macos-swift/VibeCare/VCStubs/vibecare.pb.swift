...
/// Summary of a loaded plugin, as returned by ListPlugins.
public struct VCPluginSummary: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct VCListPluginsResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var plugins: [VCPluginSummary] = []
...
public struct VCRenderPluginViewRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct VCInvokePluginActionRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension VCPluginSummary: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PluginSummary"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}name\0\u{1}icon\0\u{3}ui_kind\0\u{3}ui_entry\0\u{1}status\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularStringField(value: &self.uiKind) }()
      case 5: try { try decoder.decodeSingularStringField(value: &self.uiEntry) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.uiKind.isEmpty {
      try visitor.visitSingularStringField(value: self.uiKind, fieldNumber: 4)
    }
    if !self.uiEntry.isEmpty {
      try visitor.visitSingularStringField(value: self.uiEntry, fieldNumber: 5)
    }
  ...
  public static func ==(lhs: VCPluginSummary, rhs: VCPluginSummary) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.name != rhs.name {return false}
...
extension VCListPluginsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: VCListPluginsResponse, rhs: VCListPluginsResponse) -> Bool {
...
extension VCRenderPluginViewRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".RenderPluginViewRequest"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}plugin_id\0\u{3}view_id\0\u{1}params\0")
  ...
  public static func ==(lhs: VCRenderPluginViewRequest, rhs: VCRenderPluginViewRequest) -> Bool {
...
extension VCInvokePluginActionRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".InvokePluginActionRequest"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}plugin_id\0\u{3}view_id\0\u{1}action\0\u{1}params\0")
  ...
  public static func ==(lhs: VCInvokePluginActionRequest, rhs: VCInvokePluginActionRequest) -> Bool {
    if lhs.pluginID != rhs.pluginID {return false}
    if lhs.viewID != rhs.viewID {return false}
